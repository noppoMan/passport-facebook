...
var uri = require('url')
  ...
  OAuth2.prototype.oldgetOAuthAccessToken = OAuth2.prototype.getOAuthAccessToken;

  OAuth2.prototype.getOAuthAccessToken = function (code, params, callback) {
    this.oldgetOAuthAccessToken(code, params, function(err, accessToken, refreshToken, _params){
      if(err) {
        return callback(err);
      }
      ...
      graph.extendAccessToken({
        ...
        callback(err, facebookRes.access_token, facebookRes, facebookRes);
      });
    });
  };
